...
const categoryIcons: Record<string, string> = {
  finance: '📊', health: '❤️', education: '📚', math: '∑',
  construction: '🔨', datetime: '🕐', conversion: '📏', devtools: '💻',
}
...
export function MobileNav({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute top-0 right-0 bottom-0 w-full max-w-sm bg-background shadow-2xl overflow-y-auto transition-transform duration-300 ${
